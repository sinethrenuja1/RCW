...
//         if (customerDetails.contact_number != contactNumber) {
//             updateRegDetails();
//             console.log('hari')
//         }
//     }
...
//                                         />
//                                     </div>
//                                     <button onClick={() => setShowModal(true)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-3">
//                                         Update
//                                     </button>
//                                 </div>
//                                 <div className="flex flex-wrap justify-between mb-3">
...
//             if (response.status === 200) {
//                 setShowModal(false);
//                 // Update the customer details with the new contact number
//                 setCustomerDetails({
//                     ...customerDetails,
//                     contact_number: contactNumber,
//                 });
...
//                 </Modal.Body>
//                 <Modal.Footer>
//                     <button onClick={() => { /* Add the logic to change owner here */ }} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
//                         Confirm
//                     </button>
//                 </Modal.Footer>
//             </Modal>
...
//             const searchResponse = await axios.get(`http://localhost:8800/api/jobRoutes/searchCustomer/${newContactNumber}`);
//             if (searchResponse.status === 200) {
//                 // Customer exists, update vehicle_details
//                 await axios.put(`http://localhost:8800/api/jobRoutes/updateVehicleContact/${veh_num}`, {
//                     contact_number: newContactNumber
//                 });
//             } else {
//                 // Customer does not exist, create new customer and update vehicle_details
...
//             // Update local state with new contact number
//             setVehicleDetails({
//                 ...vehicleDetails,
//                 contact_number: newContactNumber
//             });
