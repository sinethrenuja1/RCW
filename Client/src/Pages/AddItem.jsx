    ...
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white shadow-md rounded-lg px-8 py-5">
        ...
        <form className="grid grid-cols-1 gap-4 mt-4">
          ...
          {/* <div className="flex items-center">
            <label htmlFor="date" className="w-1/4 text-right font-medium">Date:</label>
            <input type="date" id="date" name="date" className="w-2/4 rounded-md border border-gray-300 px-3 py-2" />
          </div> */}
          <div className="flex items-center">
