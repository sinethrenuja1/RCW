...
//   return (
//     <div className="fixed top-0 left-0 w-64 border-2 border-l-gray-400 bg-side-nav-bg h-screen">
//       <div className="flex flex-col items-center p-4 mb-8">
//         <img src={logo} alt="logo" className="w-24 h-24 rounded-full mb-4" />
//         <div className="text-center text-xl font-bold text-white">Kalupahana Motors</div>
//       </div>

//       <div className="font-inter text-text-primary">
//         <Link to='/dashboard'>
//           <div className={`flex pl-7 gap-1 hover:text-white hover:bg-text-primary rounded-lg p-2 cursor-pointer ${activeBar === 'dashboard' ? 'text-white bg-text-primary':''}`} onClick={() => setActiveBar('dashboard')}>
...
//         <Link to='/showbooking'>
//           <div className={`flex pl-7 gap-1 hover:text-white hover:bg-text-primary rounded-lg p-2 cursor-pointer ${activeBar === 'showbooking' ? 'text-white bg-text-primary':''}`} onClick={() => setActiveBar('showbooking')}>
//             <BookmarkIcon className='h-6 w-6'/>
//             <p className='flex items-center'>Booking</p>
//           </div>
//         </Link>

//         <div className={`flex pl-7 gap-1 rounded-lg p-2 cursor-pointer hover:text-white hover:bg-text-primary ${isJobDropdownOpen ? 'border border-gray-300 font-bold' : ''}`} onClick={toggleJobDropdown}>
...
//           <div id='subset'>
//             <Link to='/openjob'>
//               <div className={`flex pl-11 gap-1 hover:text-white hover:bg-text-primary rounded-lg p-2 cursor-pointer ${activeBar === 'openjob' ? 'text-white bg-text-primary':''}`} onClick={() => setActiveBar('openjob')}>
...
//               <div className={`flex pl-11 gap-1 hover:text-white hover:bg-text-primary rounded-lg p-2 cursor-pointer ${activeBar === 'show_jobcard' ? 'text-white bg-text-primary':''}`} onClick={() => setActiveBar('show_jobcard')}>
...
//               <div className={`flex pl-11 gap-1 hover:text-white hover:bg-text-primary rounded-lg p-2 cursor-pointer ${activeBar === 'finaljobcard' ? 'text-white bg-text-primary':''}`} onClick={() => setActiveBar('finaljobcard')}>
...
//           <div className={`flex pl-7 gap-1 hover:text-white hover:bg-text-primary rounded-lg p-2 cursor-pointer ${activeBar === 'show_services' ? 'text-white bg-text-primary':''}`} onClick={() => setActiveBar('show_services')}>
//             <HandThumbUpIcon className='h-6 w-6'/>
//             <p className='flex items-center'>Services</p>
//           </div>
//         </Link>

//         <div className={`flex pl-7 gap-1 rounded-lg p-2 cursor-pointer hover:text-white hover:bg-text-primary ${isWorkerDropdownOpen ? 'border border-gray-300 font-bold' : ''}`} onClick={toggleWorkerDropdown}>
...
//               <div className={`flex pl-11 gap-1 hover:text-white hover:bg-text-primary rounded-lg p-2 cursor-pointer ${activeBar === 'show_workers' ? 'text-white bg-text-primary':''}`} onClick={() => setActiveBar('show_workers')}>
//                 <IdentificationIcon className='h-6 w-6'/>
//                 <p>Employees</p>
//               </div>
//             </Link>
...
//             <Link to='/add_user'>
//               <div className={`flex pl-11 gap-1 hover:text-white hover:bg-text-primary rounded-lg p-2 cursor-pointer ${activeBar === 'add_user' ? 'text-white bg-text-primary':''}`} onClick={() => setActiveBar('add_user')}>
...
//         <Link to='/reports'>
//           <div className={`flex pl-7 gap-1 hover:text-white hover:bg-text-primary rounded-lg p-2 cursor-pointer ${activeBar === 'reports' ? 'text-white bg-text-primary':''}`} onClick={() => setActiveBar('reports')}>
//             <ChartBarIcon className='h-6 w-6'/>
//             <p className='flex items-center'>Reports</p>
//           </div>
//         </Link>

//         <Link to='/setting'>
//           <div className={`flex pl-7 gap-1 hover:text-white hover:bg-text-primary rounded-lg p-2 cursor-pointer ${activeBar === 'setting' ? 'text-white bg-text-primary':''}`} onClick={() => setActiveBar('setting')}>
...
//         <Link to='/'>
//           <div className='fixed flex pl-7 w-64 gap-1 hover:text-white hover:bg-text-primary rounded-lg p-2 cursor-pointer bottom-10'>
