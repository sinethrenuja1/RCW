...
//   return (
//     <div className="fixed top-0 left-0 w-64 border-r-2 border-gray-300 bg-blue-50 h-screen p-2">
//       {/* <div className="flex flex-col items-center mb-8">
//         <img src={logo} alt="logo" className="w-24 h-24 rounded-full mb-2 shadow-lg" />
//       </div> */}

//       <div className="font-inter text-gray-800 mt-20">
//         <Link to='/dashboard'>
//           <div className={`flex items-center pl-4 gap-3 pb-2 rounded-lg cursor-pointer hover:bg-blue-400 hover:text-white transition-all duration-200 ${activeBar === 'dashboard' ? 'text-white bg-blue-400' : ''}`} onClick={() => setActiveBar('dashboard')}>
